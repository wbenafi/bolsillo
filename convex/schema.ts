...
export default defineSchema({
  ...
  transactions: defineTable({
    ...
    receiptFileIds: v.optional(v.array(v.id("transactionFiles"))),
  ...
  transactionDrafts: defineTable({
    ...
    fileNames: v.optional(v.array(v.object({ fileId: v.id("transactionFiles"), displayName: v.optional(v.string()) }))),
  ...
  }).index("by_user_wallet", ["userId", "walletId"]).index("by_user_wallet_status", ["userId", "walletId", "status"]).index("by_user_key", ["userId", "clientKey"]).index("by_wallet", ["walletId"]).index("by_transaction", ["transactionId"]).index("by_expiration", ["expiresAt"]),
